...
class EnrollmentsControllerTest < ActionController::TestCase
  ...
  test "should create enrollment" do
    assert_difference('Enrollment.count') do
      post :create, enrollment: { confirmed: @enrollment.confirmed, paid: @enrollment.paid }
    end
  ...
  test "should update enrollment" do
    put :update, id: @enrollment, enrollment: { confirmed: @enrollment.confirmed, paid: @enrollment.paid }
    assert_redirected_to enrollment_path(assigns(:enrollment))
  end
